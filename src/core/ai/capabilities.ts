...
export function getProviderCapabilities(modelString: string): ProviderCapabilities {
  ...
  if (!chat) {
    throw new AIConfigError(
      ...
      `Known providers with chat: openai, anthropic, google, openrouter, opencode, litellm-proxy, deepseek, groq, together, azure-openai, dashscope, minimax, zhipu, ollama, llama-server. Pick one for models.tier.subagent.`,
    );
  }
